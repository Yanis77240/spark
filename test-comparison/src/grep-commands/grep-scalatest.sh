...
grep -o --color=never --no-group-separator "*** RUN ABORTED \*\*\*" */target/surefire-reports/*TestSuite.txt */**/target/surefire-reports/*TestSuite.txt | sed -r "s|\x1B\[[0-9;]*[mK]||g" > test-comparison/aborted-tests.txt
